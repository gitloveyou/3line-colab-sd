...
function run {
    ...
    cd $BASEPATH && python launch.py --listen --share --xformers --enable-insecure-extension-access --disable-safe-unpickle --lowvram  --no-half-vae --disable-nan-check --clip-models-path $BASEPATH/models/CLIP
}
